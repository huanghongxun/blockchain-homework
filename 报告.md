...
GitHub 地址：https://github.com/huanghongxun/blockchain-homework

| 年级     | 2017       | 专业（方向） | 软件工程                    |
| -------- | ---------- | ------------ | --------------------------- |
| 学号     | 17343050   | Email        | huangyh99@mail2.sysu.edu.cn |
| 开始日期 | 2019/10/21 | 完成日期     | 2019/10/21                  |
...
![image-20191213210450030](assets/image-20191213210450030.png)
...
![image-20191213223308830](assets/image-20191213223308830.png)
...
4. 账户地址
5. 账户公钥
6. 查询指定账户：输入账户地址查询账户信息，可以审查公司信息

![image-20191213223329815](assets/image-20191213223329815.png)

### 审核面板

提供给政府审核企业注册，允许接受和拒绝注册

![image-20191213223405115](assets/image-20191213223405115.png)

### 转账页面

输入转至账户地址，可以查询到账户名称。额外输入金额和返还日期后可以执行转账请求

![image-20191213223452370](assets/image-20191213223452370.png)

### 确认转账

企业在管理面板的借入凭证中点击接受转账或者拒绝转账

![image-20191213223533912](assets/image-20191213223533912.png)

### 还款页面

企业可以在借入凭证中返还借入的信用凭证。

![image-20191213223603049](assets/image-20191213223603049.png)

### 确认返还

债务方可以再在管理面板中确认接受信用凭证的返还

![image-20191213223726199](assets/image-20191213223726199.png)

### 查询面板

提供给金融机构查询企业的概况，以便衡量企业的信用评级。

![image-20191213223435468](assets/image-20191213223435468.png)
